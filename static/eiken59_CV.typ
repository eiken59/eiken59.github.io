...
#show: typesetting.with("CHANG Yung-Hsuan")

#let explanation(content) = hide_and_seek(true, content)
...
//     Mandarin, English#explanation(" (CEFR C1)"), Japanese#explanation(" (JLPT N2)"), and French#explanation(" (roughly CEFR B1)").

//     #linebreak()

//     *Certificates*  
    
//     SOA Exam P #explanation("(July 2025)") and Exam FM#explanation(" (December 2025, preliminary pass)").
//   ],
// )
...
#section-block(
  [Work \ Experience],
  [
    *Teaching Assistant* #h(1fr) September 2025 -- December 2025 
    ...
    *Academic Tutor* #h(1fr) October 2023 -- November 2023 #h(1.5pt) & #h(1.5pt) April 2024 -- May 2024  
    ...
    #explanation[
      Tutored international students in Calculus A (I) and Calculus A (II), conducting weekly sessions and creating #link("https://github.com/eiken59/2024_II_Tutor")[handouts] in #LaTeX.
    ]
  ]
)